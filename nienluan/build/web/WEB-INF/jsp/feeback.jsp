...
<html>
    <head>
        ...
        <title>Trang tin phản hồi khách hàng</title>
       ...
       <div class="container" style="width:100%">
        ...
        <div class="row">
                    ...
                    <div class="row" style="margin-top:8px;">  
                        ...
                        <p style="margin-left:10px;" class="pull-left"><a href="goQuanly.html">quản lý</a></p>
                        <p  style="margin-left:10px;color:blue" class="pull-left">></p>
                        <p style="margin-left:10px;" class="pull-left"><a href="goFeeback.html?tk=${tk.user}">ý kiến phản hồi khách hàng</a></p>
                    </div>
        ...
        <div class="row" style="height:600px;">
            <hr>
            <%
                      String t=(String)session.getAttribute("ctok");
                      if(t!=null){
                          %>
                            <div class="alert alert-info">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Đã trả lời cho khách hàng, và gửi tới email của họ.</strong>
                            </div>
                            <br>
                          <%
                         
                      }
                      session.removeAttribute("ctok");
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr style="background-color:#CEF6F5">
                                ...
                                <th class="text-muted">Câu hỏi của khách hàng</th>
                               
                                <th class="text-muted">Email khách hàng</th>
                                <th class="text-muted">Tình trạng</th>
                                <th class="text-muted">Hành động</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach items="${contact}" var="it" varStatus="i">
                                <tr>
                                    <td>${it.id}</td>
                                    <td>${it.cauhoi}</td>
                                    <td>${it.email}</td>
                                    <c:choose>
                                        <c:when test="${it.tinhtrang eq 'no'}">
                                            ...
                                            <td>
                                                <a class="btn btn btn-info" href="#" data-toggle="modal" data-target="#myModal${i.count}" style="color:white">Trả lời câu hỏi</a>
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" style="color:green">Gửi tới: ${it.email}</h4>
                                              </div>
                                              <div class="modal-body">
                                                  <form action="feeback.html" method="post">
                                                      <input value="${it.id}" id="gtid" name="gtid" type="hidden">
                                                      <input value="${it.email}" id="email" name="email" type="hidden">
                                                      <input value="${tk.user}" id="user" name="user" type="hidden">
                                                      <center>
                                                          <textarea name="feeback" style="height:100px;width:550px;" required="">
                                                          </textarea>
                                                          <br><br>
