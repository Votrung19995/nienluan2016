...
<html>
    <head>
        ...
        <title>Trang chi tiết hóa đơn mua hàng</title>
        ...
        <body onload="startTime()">
            ...
            <div class="container" style="width:100%">
                ...
                <div class="row">
                    ...
                    <p style="margin-left:10px;color:blue" class="p">></p>
                    <p style="margin-left:10px; " class="p"><a href="golistPur.html?id=${so}&tk=${kh.user}">chi tiết hóa đơn mua hàng</a></p>
                    </div>
...
//                                                       });
               ...
               <div class="row " style="height:650px;">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="thumbnail sd">
                        ...
                        <h3 id="an" class="text-muted" style="display:none">Hóa đơn số: <span style="color:blue">${so}</span></h3>
                        <h3 id="an1" class="text-muted" style="display:none">Khách hàng: <span style="color:green">${name}</span></h3>
                       
                    <br><br>
                    <table id="tb" class="table table-bordered table-responsive table-striped" style="display:none">
                        <thead>
                            <tr style="background-color:#AED6F1">
                                <th style="text-align:center" class="text-muted">STT</th>
                                <th style="text-align:center" class="text-muted">Mã hàng hóa</th>
                                <th style="text-align:center" class="text-muted">Số lượng mua</th>
                                <th style="text-align:center" class="text-muted">Màu sắc</th>
                                <th style="text-align:center" class="text-muted">Thành tiền</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach items="${purd}" var="pur" varStatus="i">
                                <tr>
                                <td style="text-align:center" class="text-muted">${i.count}</td>
                                <td style="text-align:center" class="text-muted">${pur.inventory.inventoryId}</td>
                                <td style="text-align:center" class="text-muted">${pur.count}</td>
                                <td style="text-align:center" class="text-muted">${pur.color}</td>
                                <td style="text-align:center" class="text-muted">${pur.cost}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
            ...
            <div class="row">
                ...
                <a href="gopurchaseManager.html?tk=${kh.user}" class="btn-sm pull-left">
                <span class="glyphicon glyphicon-chevron-left"></span>  Về trang hóa đơn mua hàng
                </a>
            </div>
