...
<html>
    <head>
        ...
        <title>Trang tin tức chi tiết</title>
        ...
        <jsp:include page="narbar.jsp"></jsp:include>
            <div class="container" style="width:100%">
                ...
                <div class="row">
                    ...
                    <p style="margin-left:10px; " class="p"><a href="goAd.html?tk=${kh.user}">tin tức - giảm giá</a></p>
                    <p style="margin-left:10px;color:blue" class="p">></p>
                    <p style="margin-left:10px; " class="p"><a href="adDetail.html?id=${kh.user}&ad=${ad.id}">chi tiết tin tức</a></p>
                    </div>
...
//                                                       });s
           ...
           <div class="row">
               ...
               <div class="col-sm-8 col-sm-offset-2">
                   ...
                   <h2 class="text-muted">${ad.tieude}</h2>
