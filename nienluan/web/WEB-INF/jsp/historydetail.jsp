        ...
        <jsp:include page="narbar.jsp"></jsp:include>
            <div class="container" style="width:100%">
                ...
                <div class="row">
                    ...
                    <p style="margin-left:10px;color:blue" class="p">></p>
                    <p style="margin-left:10px; " class="p"><a href="goHistoryDetail.html?id=${so}&tk=${kh.user}">chi tiết hóa đơn</a></p>
                    </div>
               ...
               <div class="row " style="height:650px;">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="thumbnail sd">
                        <h2 id="an" class="text-muted" style="display:none">Hóa đơn số: <span style="color:blue">${so}</span></h2>
                    <br><br>
